...
mixin _$BudgetStatus {
  ...
  $BudgetStatusCopyWith<BudgetStatus> get copyWith =>
      _$BudgetStatusCopyWithImpl<BudgetStatus>(
          this as BudgetStatus, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, category, limit, spent, remaining, percent);
...
abstract mixin class $BudgetStatusCopyWith<$Res> {
  factory $BudgetStatusCopyWith(
          BudgetStatus value, $Res Function(BudgetStatus) _then) =
      _$BudgetStatusCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'Category') Category category,
      @JsonKey(name: 'Limit') double limit,
      @JsonKey(name: 'Spent') double spent,
      @JsonKey(name: 'Remaining') double remaining,
...
/// @nodoc
class _$BudgetStatusCopyWithImpl<$Res> implements $BudgetStatusCopyWith<$Res> {
...
extension BudgetStatusPatterns on BudgetStatus {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BudgetStatus value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _BudgetStatus() when $default != null:
        return $default(_that.category, _that.limit, _that.spent,
            _that.remaining, _that.percent);
      case _:
        return orElse();
    }
  }
...
class _BudgetStatus implements BudgetStatus {
  const _BudgetStatus(
      ...
      @JsonKey(name: 'Spent') required this.spent,
      @JsonKey(name: 'Remaining') required this.remaining,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BudgetStatusCopyWith<_BudgetStatus> get copyWith =>
      __$BudgetStatusCopyWithImpl<_BudgetStatus>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BudgetStatusToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$BudgetStatusCopyWith<$Res>
    implements $BudgetStatusCopyWith<$Res> {
  factory _$BudgetStatusCopyWith(
          _BudgetStatus value, $Res Function(_BudgetStatus) _then) =
      __$BudgetStatusCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'Category') Category category,
