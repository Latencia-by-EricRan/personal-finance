...
mixin _$Account {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, type, currency, icon, archived);
...
abstract mixin class $AccountCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'Type') AccountType type,
...
extension AccountPatterns on Account {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Account() when $default != null:
        return $default(_that.id, _that.name, _that.type, _that.currency,
            _that.icon, _that.archived);
      case _:
        return orElse();
    }
  }
