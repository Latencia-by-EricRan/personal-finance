...
mixin _$MovementSummaryResponse {
  ...
  $MovementSummaryResponseCopyWith<MovementSummaryResponse> get copyWith =>
      _$MovementSummaryResponseCopyWithImpl<MovementSummaryResponse>(
          this as MovementSummaryResponse, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MovementSummaryResponse &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, month, year, summary,
...
abstract mixin class $MovementSummaryResponseCopyWith<$Res> {
  factory $MovementSummaryResponseCopyWith(MovementSummaryResponse value,
          $Res Function(MovementSummaryResponse) _then) =
      _$MovementSummaryResponseCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'month') int month,
      @JsonKey(name: 'year') int year,
      @JsonKey(name: 'summary') MovementSummary summary,
      @JsonKey(name: 'movements') List<Movement> movements});
...
extension MovementSummaryResponsePatterns on MovementSummaryResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MovementSummaryResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _MovementSummaryResponse() when $default != null:
        return $default(
            _that.month, _that.year, _that.summary, _that.movements);
      case _:
        return orElse();
    }
  }
...
class _MovementSummaryResponse implements MovementSummaryResponse {
  const _MovementSummaryResponse(
      {@JsonKey(name: 'month') required this.month,
      @JsonKey(name: 'year') required this.year,
      @JsonKey(name: 'summary') required this.summary,
      @JsonKey(name: 'movements') required final List<Movement> movements})
      : _movements = movements;
  factory _MovementSummaryResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MovementSummaryResponseCopyWith<_MovementSummaryResponse> get copyWith =>
      __$MovementSummaryResponseCopyWithImpl<_MovementSummaryResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MovementSummaryResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MovementSummaryResponse &&
            (identical(other.month, month) || other.month == month) &&
            (identical(other.year, year) || other.year == year) &&
            (identical(other.summary, summary) || other.summary == summary) &&
...
/// @nodoc
abstract mixin class _$MovementSummaryResponseCopyWith<$Res>
    implements $MovementSummaryResponseCopyWith<$Res> {
  factory _$MovementSummaryResponseCopyWith(_MovementSummaryResponse value,
          $Res Function(_MovementSummaryResponse) _then) =
      __$MovementSummaryResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'month') int month,
