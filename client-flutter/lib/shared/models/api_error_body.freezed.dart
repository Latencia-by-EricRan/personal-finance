...
@JsonKey(name: 'message') String get message;@JsonKey(name: 'errors') List<String>? get errors;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiErrorBody&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.errors, errors));
}
...
@useResult
$Res call({
@JsonKey(name: 'message') String message,@JsonKey(name: 'errors') List<String>? errors
});
...
/// Create a copy of ApiErrorBody
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? message = null,Object? errors = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'message')  String message, @JsonKey(name: 'errors')  List<String>? errors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiErrorBody() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'message')  String message, @JsonKey(name: 'errors')  List<String>? errors)  $default,) {final _that = this;
switch (_that) {
case _ApiErrorBody():
return $default(_that.message,_that.errors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'message')  String message, @JsonKey(name: 'errors')  List<String>? errors)?  $default,) {final _that = this;
switch (_that) {
case _ApiErrorBody() when $default != null:
return $default(_that.message,_that.errors);case _:
  return null;
...
class _ApiErrorBody implements ApiErrorBody {
  const _ApiErrorBody({@JsonKey(name: 'message') required this.message, @JsonKey(name: 'errors') final  List<String>? errors}): _errors = errors;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApiErrorBody&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._errors, _errors));
}
