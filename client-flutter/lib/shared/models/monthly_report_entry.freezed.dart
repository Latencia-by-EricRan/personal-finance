...
mixin _$MonthlyReportEntry {
  ...
  $MonthlyReportEntryCopyWith<MonthlyReportEntry> get copyWith =>
      _$MonthlyReportEntryCopyWithImpl<MonthlyReportEntry>(
          this as MonthlyReportEntry, _$identity);
...
abstract mixin class $MonthlyReportEntryCopyWith<$Res> {
  factory $MonthlyReportEntryCopyWith(
          MonthlyReportEntry value, $Res Function(MonthlyReportEntry) _then) =
      _$MonthlyReportEntryCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'Month') int month,
      @JsonKey(name: 'Income') double income,
      @JsonKey(name: 'Expense') double expense,
      @JsonKey(name: 'Net') double net});
}
...
extension MonthlyReportEntryPatterns on MonthlyReportEntry {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MonthlyReportEntry value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _MonthlyReportEntry() when $default != null:
        return $default(_that.month, _that.income, _that.expense, _that.net);
      case _:
        return orElse();
    }
  }
...
class _MonthlyReportEntry implements MonthlyReportEntry {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MonthlyReportEntryCopyWith<_MonthlyReportEntry> get copyWith =>
      __$MonthlyReportEntryCopyWithImpl<_MonthlyReportEntry>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MonthlyReportEntryToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$MonthlyReportEntryCopyWith<$Res>
    implements $MonthlyReportEntryCopyWith<$Res> {
  factory _$MonthlyReportEntryCopyWith(
          _MonthlyReportEntry value, $Res Function(_MonthlyReportEntry) _then) =
      __$MonthlyReportEntryCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'Month') int month,
